...
CLIPS = {
    ...
    # 가슴 높이까지 올려야 진짜 "교차"로 보이므로 lift 델타를 크게(z≈0.78) 준다.
    "idle/arms_crossed.vmd": {
        L_ARM:   [(0, (0.30, 0, 0.78)), (60, (0.31, 0, 0.79)), (120, (0.30, 0, 0.78))],
        L_ELBOW: [(0, (0, -1.58, 0)), (120, (0, -1.58, 0))],
        R_ARM:   [(0, (0.30, 0, -0.78)), (60, (0.31, 0, -0.79)), (120, (0.30, 0, -0.78))],
        R_ELBOW: [(0, (0, 1.58, 0)), (120, (0, 1.58, 0))],
    },
    # 한 손 허리: 오른손을 허리에.
