...
CLIPS = {
    ...
    # ── 전신 연기 배치 2 (2026-07-04) — 일상 연기 5종. 컨벤션: frame 0 =
    # 마지막 frame = 중립(0) 명시 키(전 본·모프, Codex MUST-FIX), 팔 전방
    # 도달은 검증된 curious/ponder 계열 값만 사용.
    # 인사 꾸벅: 상체 굽힘+머리 따라, 팔은 몸 옆에 살짝 앞. 비서 첫인상 연기.
    "react/bow.vmd": {
        "bones": {
            UPPER:  [(0, (0, 0, 0)), (22, (0.32, 0, 0)), (40, (0.32, 0, 0)), (70, (0, 0, 0)), (80, (0, 0, 0))],
            UPPER2: [(0, (0, 0, 0)), (22, (0.10, 0, 0)), (40, (0.10, 0, 0)), (70, (0, 0, 0)), (80, (0, 0, 0))],
            HEAD:   [(0, (0, 0, 0)), (22, (0.12, 0, 0)), (40, (0.12, 0, 0)), (70, (0, 0, 0)), (80, (0, 0, 0))],
            NECK:   [(0, (0, 0, 0)), (22, (0.05, 0, 0)), (40, (0.05, 0, 0)), (70, (0, 0, 0)), (80, (0, 0, 0))],
            L_ARM:  [(0, (0, 0, 0)), (20, (0.06, 0, 0.05)), (45, (0.06, 0, 0.05)), (70, (0, 0, 0)), (80, (0, 0, 0))],
            R_ARM:  [(0, (0, 0, 0)), (20, (0.06, 0, -0.05)), (45, (0.06, 0, -0.05)), (70, (0, 0, 0)), (80, (0, 0, 0))],
        },
        "morphs": {
            "にこり": [(0, 0.0), (15, 0.5), (50, 0.5), (75, 0.0), (80, 0.0)],
        },
    },
    # 신남: 어깨 번갈아 들썩 두 번 + 주먹 쥔 팔 들어올림, 활짝 웃음.
    "react/excited.vmd": {
        "bones": {
            L_SHOULDER: [(0, (0, 0, 0)), (10, (0, 0, 0.12)), (22, (0, 0, 0.03)), (34, (0, 0, 0.12)), (46, (0, 0, 0.02)), (60, (0, 0, 0)), (66, (0, 0, 0))],
            R_SHOULDER: [(0, (0, 0, 0)), (12, (0, 0, -0.12)), (24, (0, 0, -0.03)), (36, (0, 0, -0.12)), (48, (0, 0, -0.02)), (60, (0, 0, 0)), (66, (0, 0, 0))],
            UPPER:  [(0, (0, 0, 0)), (12, (-0.06, 0, 0)), (30, (0.03, 0, 0)), (56, (0, 0, 0)), (66, (0, 0, 0))],
            HEAD:   [(0, (0, 0, 0)), (12, (-0.08, 0, 0)), (30, (0.05, 0, 0)), (56, (0, 0, 0)), (66, (0, 0, 0))],
            NECK:   [(0, (0, 0, 0)), (12, (-0.03, 0, 0)), (30, (0.02, 0, 0)), (56, (0, 0, 0)), (66, (0, 0, 0))],
            # 1차값(z0.24+팔꿈치1.05)은 원거리에서 "허리에 손" 정도로만 읽혀 신남이
            # 약했다(스크린샷 검수). 들어올림을 키움 — z0.42는 기형 함정(0.7)과
            # 검증된 curious(0.26) 사이, 팔꿈치 1.15는 경고 경계(1.45) 아래.
            L_ARM:   [(0, (0, 0, 0)), (14, (0.18, 0, 0.42)), (40, (0.18, 0, 0.42)), (60, (0, 0, 0)), (66, (0, 0, 0))],
            R_ARM:   [(0, (0, 0, 0)), (14, (0.18, 0, -0.42)), (40, (0.18, 0, -0.42)), (60, (0, 0, 0)), (66, (0, 0, 0))],
            L_ELBOW: [(0, (0, 0, 0)), (14, (0, -1.15, 0)), (40, (0, -1.15, 0)), (60, (0, 0, 0)), (66, (0, 0, 0))],
            R_ELBOW: [(0, (0, 0, 0)), (14, (0, 1.15, 0)), (40, (0, 1.15, 0)), (60, (0, 0, 0)), (66, (0, 0, 0))],
        },
        "morphs": {
            "にっこり": [(0, 0.0), (10, 0.85), (45, 0.85), (62, 0.0), (66, 0.0)],
            "眉上移動": [(0, 0.0), (8, 0.5), (40, 0.5), (60, 0.0), (66, 0.0)],
        },
    },
    # 뾰로통: 고개 돌려 외면+살짝 숙임, 손 뒤로(가벼운 뒷짐), 삐친 표정.
    "react/pout.vmd": {
        "bones": {
            HEAD:  [(0, (0, 0, 0)), (18, (0.06, 0.20, 0.04)), (60, (0.06, 0.20, 0.04)), (90, (0, 0, 0)), (96, (0, 0, 0))],
            NECK:  [(0, (0, 0, 0)), (18, (0.02, 0.08, 0)), (60, (0.02, 0.08, 0)), (90, (0, 0, 0)), (96, (0, 0, 0))],
            UPPER: [(0, (0, 0, 0)), (20, (0, 0.06, 0)), (60, (0, 0.06, 0)), (90, (0, 0, 0)), (96, (0, 0, 0))],
            L_ARM:   [(0, (0, 0, 0)), (16, (-0.14, 0, 0.05)), (70, (-0.14, 0, 0.05)), (92, (0, 0, 0)), (96, (0, 0, 0))],
            L_ELBOW: [(0, (0, 0, 0)), (16, (0, -0.50, 0)), (70, (0, -0.50, 0)), (92, (0, 0, 0)), (96, (0, 0, 0))],
            R_ARM:   [(0, (0, 0, 0)), (16, (-0.14, 0, -0.05)), (70, (-0.14, 0, -0.05)), (92, (0, 0, 0)), (96, (0, 0, 0))],
            R_ELBOW: [(0, (0, 0, 0)), (16, (0, 0.50, 0)), (70, (0, 0.50, 0)), (92, (0, 0, 0)), (96, (0, 0, 0))],
        },
        "morphs": {
            "怒り":     [(0, 0.0), (14, 0.35), (70, 0.35), (90, 0.0), (96, 0.0)],
            "じと目":   [(0, 0.0), (14, 0.45), (70, 0.45), (90, 0.0), (96, 0.0)],
            "口角下げ": [(0, 0.0), (14, 0.5), (70, 0.5), (90, 0.0), (96, 0.0)],
        },
    },
    # 하품: 고개 젖히며 입 벌리고 눈 감김 → 나른하게 떨굼 → 회복. 클립이
    # まばたき를 소유해 이중 감김 없음(표정 런타임 양보, 검증된 메커니즘).
    "idle/yawn.vmd": {
        "bones": {
            HEAD:  [(0, (0, 0, 0)), (25, (-0.20, 0, 0)), (55, (-0.20, 0, 0)), (75, (0.10, 0, 0)), (110, (0, 0, 0)), (120, (0, 0, 0))],
            NECK:  [(0, (0, 0, 0)), (25, (-0.07, 0, 0)), (55, (-0.07, 0, 0)), (75, (0.04, 0, 0)), (110, (0, 0, 0)), (120, (0, 0, 0))],
            UPPER: [(0, (0, 0, 0)), (25, (-0.06, 0, 0)), (55, (-0.06, 0, 0)), (75, (0.03, 0, 0)), (110, (0, 0, 0)), (120, (0, 0, 0))],
            L_SHOULDER: [(0, (0, 0, 0)), (20, (0, 0, 0.08)), (60, (0, 0, 0.08)), (75, (0, 0, -0.02)), (110, (0, 0, 0)), (120, (0, 0, 0))],
            R_SHOULDER: [(0, (0, 0, 0)), (20, (0, 0, -0.08)), (60, (0, 0, -0.08)), (75, (0, 0, 0.02)), (110, (0, 0, 0)), (120, (0, 0, 0))],
            L_ARM: [(0, (0, 0, 0)), (25, (0.05, 0, 0.06)), (60, (0.05, 0, 0.06)), (100, (0, 0, 0)), (120, (0, 0, 0))],
            R_ARM: [(0, (0, 0, 0)), (25, (0.05, 0, -0.06)), (60, (0.05, 0, -0.06)), (100, (0, 0, 0)), (120, (0, 0, 0))],
        },
        "morphs": {
            "あ":       [(0, 0.0), (20, 0.65), (45, 0.75), (70, 0.0), (120, 0.0)],
            "まばたき": [(0, 0.0), (30, 1.0), (65, 1.0), (80, 0.0), (120, 0.0)],
            "なごみ":   [(0, 0.0), (70, 0.4), (100, 0.4), (115, 0.0), (120, 0.0)],
        },
    },
    # 자기 손 구경: 양 전완을 앞으로 들어 내려다봄. 팔 값은 curious에서 검증된
    # 전방 안전 조합(x0.24+z±0.26, 팔꿈치 ∓1.02) 그대로(Codex MUST-FIX).
    "idle/look_hands.vmd": {
        "bones": {
            L_ARM:   [(0, (0, 0, 0)), (20, (0.24, 0, 0.26)), (80, (0.24, 0, 0.26)), (105, (0, 0, 0)), (110, (0, 0, 0))],
            R_ARM:   [(0, (0, 0, 0)), (20, (0.24, 0, -0.26)), (80, (0.24, 0, -0.26)), (105, (0, 0, 0)), (110, (0, 0, 0))],
            L_ELBOW: [(0, (0, 0, 0)), (20, (0, -1.02, 0)), (80, (0, -1.02, 0)), (105, (0, 0, 0)), (110, (0, 0, 0))],
            R_ELBOW: [(0, (0, 0, 0)), (20, (0, 1.02, 0)), (80, (0, 1.02, 0)), (105, (0, 0, 0)), (110, (0, 0, 0))],
            HEAD:  [(0, (0, 0, 0)), (22, (0.16, 0, 0.03)), (80, (0.16, 0, 0.03)), (105, (0, 0, 0)), (110, (0, 0, 0))],
            NECK:  [(0, (0, 0, 0)), (22, (0.06, 0, 0.01)), (80, (0.06, 0, 0.01)), (105, (0, 0, 0)), (110, (0, 0, 0))],
        },
        "morphs": {
            "にこり": [(0, 0.0), (25, 0.4), (85, 0.4), (105, 0.0), (110, 0.0)],
        },
    },
    ...
    # 90f(3s)로 압축(테스터: 머리 소유 4초는 시선 정지가 길다) + 표정 진폭 업
    # (데스크톱 거리에서 眉上 0.35/にこり 0.25는 식별 불가 — 테스터 검수).
    "idle/curious.vmd": {
        "bones": {
            HEAD:  [(0, (0, 0, 0)), (19, (0.02, 0.08, 0.14)), (45, (0.03, 0.10, 0.18)),
                    (71, (0.02, 0.06, 0.10)), (90, (0, 0, 0))],
            NECK:  [(0, (0, 0, 0)), (19, (0.01, 0.03, 0.06)), (45, (0.01, 0.04, 0.07)),
                    (71, (0.01, 0.02, 0.04)), (90, (0, 0, 0))],
            UPPER: [(0, (0, 0, 0)), (22, (0.02, 0, 0.04)), (45, (0.03, 0, 0.05)),
                    (90, (0, 0, 0))],
            UPPER2: [(0, (0, 0, 0)), (22, (0.01, 0, 0.02)), (45, (0.01, 0, 0.03)),
                     (90, (0, 0, 0))],
            LOWER: [(0, (0, 0, 0)), (22, (0, 0, 0.03)), (45, (0, 0, 0.04)),
                    (71, (0, 0, 0.02)), (90, (0, 0, 0))],
            L_LEG:  [(0, (0, 0, 0)), (90, (0, 0, 0))],
            R_LEG:  [(0, (0, 0, 0)), (90, (0, 0, 0))],
            L_KNEE: [(0, (0, 0, 0)), (90, (0, 0, 0))],
            R_KNEE: [(0, (0, 0, 0)), (90, (0, 0, 0))],
            ...
            L_ARM:   [(0, (0, 0, 0)), (15, (0.24, 0, 0.26)), (75, (0.24, 0, 0.26)), (90, (0, 0, 0))],
            L_ELBOW: [(0, (0, 0, 0)), (15, (0, -1.02, 0)), (75, (0, -1.02, 0)), (90, (0, 0, 0))],
            R_ARM:   [(0, (0, 0, 0)), (15, (0.24, 0, -0.26)), (75, (0.24, 0, -0.26)), (90, (0, 0, 0))],
            R_ELBOW: [(0, (0, 0, 0)), (15, (0, 1.02, 0)), (75, (0, 1.02, 0)), (90, (0, 0, 0))],
        },
        "morphs": {
            "眉上移動": [(0, 0.0), (19, 0.5), (68, 0.45), (90, 0.0)],
            "にこり":   [(0, 0.0), (22, 0.35), (71, 0.3), (90, 0.0)],
        },
    },
}
