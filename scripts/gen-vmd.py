...
CLIPS = {
    ...
    # 기지개(양팔 바깥으로 들었다 내림) — #2 AI 저작 파이프라인 산출물 중 큐레이션
    # 채택분(로컬 Qwen 생성→다각도 검수→편입). 양팔 z를 rest(∓0.7)에서 바깥(∓0.3)으로
    # 들었다 복귀. 동적·안전 자동검증 통과(maxVar 0.4).
    "idle/stretch_arms.vmd": {
        L_ARM: [(0, (0, 0, -0.7)), (30, (0, 0, -0.5)), (60, (0, 0, -0.3)), (90, (0, 0, -0.55)), (120, (0, 0, -0.7))],
        R_ARM: [(0, (0, 0, 0.7)), (30, (0, 0, 0.5)), (60, (0, 0, 0.3)), (90, (0, 0, 0.55)), (120, (0, 0, 0.7))],
    },
    # 한 손 살짝 들어 인사(비대칭 제스처) — #2 AI 저작 큐레이션 채택분(2차 배치).
    # 오른팔만 바깥+앞으로 들었다 내림(나머지 idle이 대부분 대칭이라 변주로 가치).
    "idle/wave.vmd": {
        R_ARM: [(0, (0, 0, -0.5)), (30, (0, 0, -0.3)), (60, (0, 0.1, -0.4)), (90, (0, 0.3, -0.3)), (120, (0, 0, -0.5))],
    },
    # 뒷짐(양손 허리 뒤쪽으로).
    "idle/hands_back.vmd": {
